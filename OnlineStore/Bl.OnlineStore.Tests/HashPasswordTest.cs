	...
	public class HashPasswordTest
	{
		...
		public void GeneratePasswordHash_HashGenerator()
		{
			...
			for (int i = 0; i < 1000; i++)
			{
				...
				int loginLength = rand.Next(UserAccess.LoginMinLength, UserAccess.LoginMaxLength);
				int passwordLength = rand.Next(UserAccess.PasswordMinLength, UserAccess.PasswordMaxLength);
				...
				Assert.IsTrue(hash.Length== UserAccess.PasswordHashLength);
