...
namespace CommonEntities
{
	public class User : BaseDbEntity
	{
		...
		public User(int userId, string firsName, string lastName, string email, string phone, int userAccessId) : base(userId)
		{
			FirsName = firsName;
			LastName = lastName;
			Email = email;
		...
		public User(string firsName, string lastName, string email, string phone, int userAccessId) 
		{
			FirsName = firsName;
			LastName = lastName;
			Email = email;
		...
		public User(int userId, string firsName, string lastName, string email, string phone, UserAccess userAccess) : base(userId)
		{
			FirsName = firsName;
			LastName = lastName;
			Email = email;
		...
		public User(string firsName, string lastName, string email, string phone, UserAccess userAccess)
		{
			FirsName = firsName;
			LastName = lastName;
			Email = email;
