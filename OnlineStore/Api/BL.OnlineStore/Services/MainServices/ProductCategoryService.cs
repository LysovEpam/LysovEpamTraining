...
namespace BL.OnlineStore.Services.MainServices
{
	public class ProductCategoryService : IProductCategoryService
	{
		...
		public ServiceResult SaveNewCategory(string sessionToken, ProductCategory productCategory)
		{
		...
		public ServiceResult UpdateCategory(string sessionToken, ProductCategory productCategory)
		{
			var result = _dbContext.ProductCategories.Find(category => category.CategoryName == productCategory.CategoryName);
			if (result.Count != 0)
			{
		...
		public ServiceResult DeleteCategory(string sessionToken, int id)
		{
