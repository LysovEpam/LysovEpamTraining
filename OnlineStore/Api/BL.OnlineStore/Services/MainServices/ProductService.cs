...
namespace BL.OnlineStore.Services.MainServices
{
	public class ProductService :  IProductService
	{
		...
		public ServiceResult SaveNewProduct(string sessionToken, ProductDataRequest productData)
		{
		...
		public ServiceResult UpdateProduct(string sessionToken, ProductDataRequest productData)
		{
		...
		public ServiceResult DeleteProduct(string sessionToken, int id)
		{
