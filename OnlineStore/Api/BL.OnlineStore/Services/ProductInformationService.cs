...
namespace BL.OnlineStore.Services
{
	public class ProductInformationService :  IProductInformationService
	{
		...
		public ServiceResult SaveNewProductInformation(ProductInformation productInformation)
		{
		...
		public ServiceResult UpdateProductInformation(ProductInformation productInformation)
		{
		...
		public ServiceResult DeleteProductInformation(int id)
		{
