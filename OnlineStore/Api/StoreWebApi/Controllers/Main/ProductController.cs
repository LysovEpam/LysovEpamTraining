...
namespace StoreWebApi.Controllers.Main
{
	...
	public class ProductController : Controller
	{
		...
		public ActionResult Create([FromBody]ProductDataRequest productData)
		{
			...
			ProductDataRequestValidator dataRequestValidator = new ProductDataRequestValidator();

			ValidationResult validationResult = dataRequestValidator.Validate(productData);
			...
			ServiceResult result = _productService.SaveNewProduct(sessionToken, productData);
		...
		public ActionResult Update([FromBody]ProductDataRequest productData)
		{
			...
			ServiceResult result = _productService.UpdateProduct(sessionToken, productData);
		...
		public ActionResult Delete(int id)
		{
			...
			ServiceResult result = _productService.DeleteProduct(sessionToken, id);
